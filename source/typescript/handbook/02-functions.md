<!--
Source: https://raw.githubusercontent.com/microsoft/TypeScript-Website/v2/packages/documentation/copy/en/handbook-v2/More%20on%20Functions.md
License: Apache-2.0
...
Using rest arguments may require turning on [`downlevelIteration`](https://www.typescriptlang.org/docs/handbook/2/tsconfig#downlevelIteration) when targeting older runtimes.
