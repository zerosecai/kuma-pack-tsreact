<!--
Source: https://raw.githubusercontent.com/microsoft/TypeScript-Website/v2/packages/documentation/copy/en/handbook-v2/Object%20Types.md
License: Apache-2.0
...
We can also read from those properties - but when we do under [`strictNullChecks`](https://www.typescriptlang.org/docs/handbook/2/tsconfig#strictNullChecks), TypeScript will tell us they're potentially `undefined`.
...
Using [mapping modifiers](https://www.typescriptlang.org/docs/handbook/2/docs/handbook/2/mapped-types.html#mapping-modifiers), you can remove `readonly` attributes.
...
This also means that we can avoid overloads entirely by instead using [generic functions](https://www.typescriptlang.org/docs/handbook/2/docs/handbook/2/functions.html#generic-functions).
...
Tuples types can be used in [rest parameters and arguments](https://www.typescriptlang.org/docs/handbook/2/docs/handbook/2/functions.html#rest-parameters-and-arguments), so that the following:
