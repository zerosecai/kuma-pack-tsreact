<!--
Source: https://raw.githubusercontent.com/vitejs/vite/main/docs/config/shared-options.md
License: MIT
...
See [Project Root](https://vitejs.dev/guide/#index-html-and-project-root) for more details.

## base

- **Type:** `string`
- **Default:** `/`
- **Related:** [`server.origin`](https://vitejs.dev/config/server-options.md#server-origin)
...
See [Public Base Path](https://vitejs.dev/guide/build#public-base-path) for more details.
...
See [Env Variables and Modes](https://vitejs.dev/guide/env-and-mode) for more details.
...
Array of plugins to use. Falsy plugins are ignored and arrays of plugins are flattened. If a promise is returned, it would be resolved before running. See [Plugin API](https://vitejs.dev/guide/api-plugin) for more details on Vite plugins.
...
See [The `public` Directory](https://vitejs.dev/guide/assets#the-public-directory) for more details.
...
More advanced custom resolution can be achieved through [plugins](https://vitejs.dev/guide/api-plugin).

::: warning Using with SSR
If you have configured aliases for [SSR externalized dependencies](https://vitejs.dev/guide/ssr.md#ssr-externals), you may want to alias the actual `node_modules` packages. Both [Yarn](https://classic.yarnpkg.com/en/docs/cli/add/#toc-yarn-add-alias) and [pnpm](https://pnpm.io/aliases/) support aliasing via the `npm:` prefix.
:::
...
Enables the tsconfig paths resolution feature. `paths` option in `tsconfig.json` will be used to resolve imports. See [Features](https://vitejs.dev/guide/features.md#paths) for more details.

## html.cspNonce

- **Type:** `string`
- **Related:** [Content Security Policy (CSP)](https://vitejs.dev/guide/features#content-security-policy-csp)
...
The search is done using [postcss-load-config](https://github.com/postcss/postcss-load-config) and only the supported config file names are loaded. Config files outside the workspace root (or the [project root](https://vitejs.dev/guide/#index-html-and-project-root) if no workspace is found) are not searched by default. You can specify a custom path outside of the root to load the specific config file instead if needed.
...
- **Related:** [Static Asset Handling](https://vitejs.dev/guide/assets)
...
See [here](https://vitejs.dev/guide/env-and-mode#env-files) for more about environment files.
...
Learn more in Vite's [SSR guide](https://vitejs.dev/guide/ssr#vite-cli). Related: [`server.middlewareMode`](./server-options#server-middlewaremode).
...
- **Related:** [Breaking Changes](https://vitejs.dev/changes/)
...
See the [Breaking Changes](https://vitejs.dev/changes/) page for details of the possible options.
